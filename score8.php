<?php
	$connection=mysqli_connect("localhost","root","","project") or die("Couldn't connect to server");
		...
		$query = "UPDATE dashboard SET level1=$level1score ,level2=$level2score ,level3=$level3score ,level4=$level4score ,level5=$level5score ,level6=$level6score ,level7=$level7score ,level8=$level8score where username='$username'";
